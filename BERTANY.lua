...
io.write('\27[0;31m\n • ابـعـت تـوكـن الـبـوت بـتـاعـك 💖🧚‍♀️ :\na┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n الـتـوكـن بـتـاعـك غـلـط اتـاكـد مـنـه وابـعـتـه تـانـي 😢💔')
else
io.write('\27[0;31m تـم حـفـظ الـتـوكـن بـنـجـاح 💖🧚‍♀️ \na┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n27[0;39;49m')
local json = JSON.decode(url)
database:set(id_server..":token_username","@"..json.result.username)
database:set(id_server..":token",token)
end 
else
print('\27[0;35m┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n لـم يـتـم حـفـظ الـتـوكـن ارسـل لـي الـتـوكن الان ☺️')
end 
os.execute('lua El BARTANY.lua')
end
if not database:get(id_server..":SUDO:ID") then 
io.write('\27[0;35m\n ابـعـت الايـدي بـتـاع الـمـطـور الاسـاسـي ♕ :\na┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\27[0;33;49m') 
local SUDOID = io.read() 
if SUDOID ~= '' then 
io.write('\27[1;35m تـم حـفـظ الايـدي الـمـطـور الاسـاسـي ✅ \na┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n27[0;39;49m') 
database:set(id_server..":SUDO:ID",SUDOID) 
else 
print('\27[0;31m┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n لـم يـتــم حـفـظ الايـدي الـمـطـور الاسـاسـي ابـعـت تـانـي ') 
end  
os.execute('lua El BARTANY.lua') 
end
if not database:get(id_server..":SUDO:USERNAME") then
io.write('\27[1;31m • ارسـل الـيـوزر بـتـاع الـمـطـور الاسـاسـي 🧚‍♀️ي :\n SEND ID FOR SIDO : \27[0;39;49m')
local SUDOUSERNAME = io.read():gsub('@','')
if SUDOUSERNAME ~= '' then
io.write('\n\27[1;34m تـم حـفـظ الـيـوزر بـتـاع الـمـطـور الاسـاسـي 🧚‍♀️ :\n\27[0;39;49m')
database:set(id_server..":SUDO:USERNAME",'@'..SUDOUSERNAME)
else
print('\n\27[1;34m لم يتـم حـفـظ الـيـوزر بـتـاع الـمـطـور الاسـاسـي 🧚‍♀️ :')
end 
os.execute('lua El BARTANY.lua')
end
...
print('\n\27[1;34m Welcome to the all-new and powerful Source El Bertany')
file = io.open("El BARTANY", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/El BARTANY
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./El BARTANY.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S El BARTANY -X kill
screen -S El BARTANY ./El BARTANY
done
]])  
file:close() 
...
if hash or SudoBot(msg) or DevEl BARTANYW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevEl BARTANYW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevEl BARTANYW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevEl BARTANYW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevEl BARTANYW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevEl BARTANYW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevEl BARTANYW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "El_BARTANY")
...
local El BARTANY_Msg = ''  
if msgs < 100 then 
El BARTANY_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
El BARTANY_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
El BARTANY_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
El BARTANY_Msg = 'متفاعل' 
elseif msgs < 1200 then 
El BARTANY_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
El BARTANY_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
El BARTANY_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
El BARTANY_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
El BARTANY_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
El BARTANY_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
El BARTANY_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
El BARTANY_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
El BARTANY_Msg = 'رب التفاعل'  
end 
return El BARTANY_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceEl BARTANY(msg,data) -- بداية العمل
if msg then
...
if DevEl BARTANYW(msg) then
local bl = ' ❃∫ اهلا عزيزي آلمـطـور\n ❃∫ آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n ❃∫ تسـتطـيع‌‏ آلتحگم باوامر البوت\n ❃∫ من خلاال الكيبورت خاص بك\n ❃∫ قناة سورس البوت [اضغط هنا](t.me/El_BARTANY)'
local keyboard = {
...
if start then 
SourceEl BARTANYr = start
else
SourceEl BARTANYr = '❃∫ اهلا عزيزي\n ❃∫ انا بوت اسمي '..Namebot..'\n ❃∫ اختصاصي حمايه الجروبات\n ❃∫ من تكرار والسبام والتوجيه والخ…\n ❃∫ لتفعيلي اتبع الاخطوات…↓\n ❃∫ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ❃∫ [قناة سورس البوت](http://t.me/El_BARTANY)'
end 
send(msg.chat_id_, msg.id_, SourceEl BARTANYr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevEl BARTANYW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevEl BARTANYW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,El BARTANY_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevEl BARTANYW(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevEl BARTANYW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevEl BARTANYW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevEl BARTANYW(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevEl BARTANYW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❃∫ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevEl BARTANYW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevEl BARTANYW(msg) then 
...
if text == 'تحديث السورس ❃' and DevEl BARTANYW(msg) then 
os.execute('rm -rf El BARTANY.lua')
os.execute('wget https://raw.githubusercontent.com/El BARTANYTEAM/El BARTANY/master/El BARTANY.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس البريطاني \n ❃∫ الاصدار » { 1.0v }')
dofile('El BARTANY.lua')  
end
if text == 'تحديث المتجر ❃' and DevEl BARTANYW(msg) then 
  io.popen("mkdir File_Bot")
  io.popen("cd File_Bot && rm -rf ga.lua.1") 
  io.popen("cd File_Bot && rm -rf ga.lua.2") 
  io.popen("cd File_Bot && rm -rf ga.lua.3") 
  io.popen("cd File_Bot && wget https://raw.githubusercontent.com/El BARTANYTEAM/Files_El BARTANY/master/File_Bot/ga.lua")  
  io.popen("cd File_Bot && wget https://raw.githubusercontent.com/El BARTANYTEAM/Files_El BARTANY/master/File_Bot/rd.lua") 
  send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث \n ❃∫ لديك اخر اصدار للمتجر')
  dofile('El BARTANY.lua')  
  end
if text == 'رقم البناء ❃' and DevEl BARTANYW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اهلاء عزيزي \n رقم البناء خاص بوتك {lua~{m7a29}')
end
if text == 'الاصدار ❃' and DevEl BARTANYW(msg) then 
  database:del(bot_id..'Srt:Bot') 
  send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس البريطاني  \n ❃∫ الاصدار »{ 1.0v }')
  end
  if text == 'مطور السورس ❃' and DevEl BARTANYW(msg) then 
    database:del(bot_id..'Srt:Bot') 
    send(msg.chat_id_, msg.id_,' ❃∫ تنويه : قبل لا تراسل المطور تاكد انو عندك شغله مهمه \n\n المطور - @F_q_w1 ')
    end
if text == 'قناه تحديثات البوت ❃' and DevEl BARTANYW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/El_BARTANY) \n ❃∫ [قناه السورس](t.me/El_BARTANY)')
end
if text == "ضع اسم للبوت ❃" and DevEl BARTANYW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevEl BARTANYW(msg) then 
...
if text == 'المشتركين ❃' and DevEl BARTANYW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات ❃' and DevEl BARTANYW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الجروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevEl BARTANYW(msg) then
...
if text == ("قائمه العام ❃") and DevEl BARTANYW(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevEl BARTANYW(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevEl BARTANYW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevEl BARTANYW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevEl BARTANYW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevEl BARTANYW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevEl BARTANYW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❃' and DevEl BARTANYW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevEl BARTANYW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الجروبات ❃" and DevEl BARTANYW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local El BARTANY = (w + q)
local sendok = #group - El BARTANY
if q == 0 then
El BARTANY = ''
else
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الجروبات الان » { '..#group..' }'..El BARTANYk..''..El BARTANY..'\n❃∫  الان عدد الجروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevEl BARTANYW(msg) then
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'El_BARTANY')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevEl BARTANYW(msg) then
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'El_BARTANY')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevEl BARTANYW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevEl BARTANYW(msg) then
...
local El BARTANY1_Msg = database:get(bot_id.."El BARTANY1:Add:Filter:Rp2"..text..msg.chat_id_)   
if El BARTANY1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'El_BARTANY')..') \n ❃∫ '..El BARTANY1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if El BARTANY_Msg and not Special(msg) then  
local El BARTANY_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if El BARTANY_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..El BARTANY_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/El_BARTANY)}\n ❃∫ ["..El BARTANY_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/El_BARTANY)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevEl BARTANYW(msg) then
...
'\n ❃∫ الرابط {['..LinkGp..']}'
if not DevEl BARTANYW(msg) then
sendText(SUDO,Text,0,'md')
end
end
end,nil) 
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevEl BARTANYW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevEl BARTANYW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevEl BARTANYW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevEl BARTANYW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❃∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevEl BARTANYW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevEl BARTANYW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevEl BARTANYW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❃∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevEl BARTANYW(msg) then  
...
database:sadd(bot_id.."El BARTANY:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."El BARTANY:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_El BARTANY = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_El BARTANY then 
names_El BARTANY = database:smembers(bot_id.."El BARTANY:blocname"..msg.chat_id_) or ""
if names_El BARTANY and names_El BARTANY[1] then 
for i=1,#names_El BARTANY do 
if name_El BARTANY:match("(.*)("..names_El BARTANY[i]..")(.*)") then 
...
database:set(bot_id.."El BARTANY:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."El BARTANY:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."El BARTANY:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."El BARTANY:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."El BARTANY:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_El BARTANYa_new(El BARTANY1,El BARTANY2)
if El BARTANY2 and El BARTANY2.first_name_ then 
if El BARTANY2.first_name_:match("(.*)"..database:get(bot_id.."El BARTANY:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."El BARTANY:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local El BARTANY_nnn = database:get(bot_id.."El BARTANY:nump"..msg.chat_id_) or 5
local El BARTANY_nnn2 = database:get(bot_id.."El BARTANY:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(El BARTANY_nnn2) == tonumber(El BARTANY_nnn) or tonumber(El BARTANY_nnn2) > tonumber(El BARTANY_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."El BARTANY:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..El BARTANY2.username_.."](https://t.me/"..(El BARTANY2.username_ or "El_BARTANY")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."El BARTANY:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(El BARTANY_nnn) - tonumber(El BARTANY_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_El BARTANYa_new)
end
end
...
local El BARTANYChengName = database:get(bot_id.."El BARTANY:Cheng:Name"..data.id_)
if not data.first_name_ then 
if El BARTANYChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..El BARTANYChengName..']')
database:del(bot_id.."El BARTANY:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if El BARTANYChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."El BARTANY:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local El BARTANYChengUserName = database:get(bot_id.."El BARTANY:Cheng:UserName"..data.id_)
if not data.username_ then 
if El BARTANYChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..El BARTANYChengUserName..']')
database:del(bot_id.."El BARTANY:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if El BARTANYChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."El BARTANY:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local El BARTANYChengPhoto = database:get(bot_id.."El BARTANY:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if El BARTANYChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."El BARTANY:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if El BARTANYChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."El BARTANY:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
  ...
  ↬ .El BARTANY TEAM  
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
  ↬ . [Channel](t.me/El_BARTANY)  
  
  ↬ . [DEVELOPER](t.me/JJEJJ)       
   
  ↬ . [Information](t.me/El_BARTANY) 
...
if text == 'رفع نسخه الاحتياطيه' and DevEl BARTANYW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'El_BARTANY')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'El_BARTANY')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevEl BARTANYW(msg) then    
dofile('El BARTANY.lua')  
send(msg.chat_id_, msg.id_, ' ❃∫ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevEl BARTANYW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevEl BARTANYW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevEl BARTANYW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevEl BARTANYW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevEl BARTANYW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevEl BARTANYW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevEl BARTANYW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevEl BARTANYW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevEl BARTANYW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevEl BARTANYW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevEl BARTANYW(msg) then
...
if text == 'الملفات' and DevEl BARTANYW(msg) then
t = ' ❃∫ ملفات السورس البريطاني  ↓\n≪━━━━━━𝘽𝙆━━━━━━≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevEl BARTANYW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/El BARTANYTEAM/Files_El BARTANY/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات بويكا\n ❃∫ ملفات السورس ↓\n≪━━━━━━𝘽𝙆━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝘽𝙆━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس البريطاني  ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/El_BARTANY) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevEl BARTANYW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/El BARTANYTEAM/Files_El BARTANY/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('El BARTANY.lua')  
else
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس البريطاني  \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevEl BARTANYW(msg) then
...
if text == "مسح الملفات" and DevEl BARTANYW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ❃∫ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevEl BARTANYW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevEl BARTANYW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "El_BARTANY")
...
function Function_El BARTANY(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_El BARTANY, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_El BARTANY, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'El_BARTANY')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'El_BARTANY')..')'
...
database:set(bot_id.."El BARTANY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."El BARTANY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."El BARTANY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."El BARTANY1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."El BARTANY1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."El BARTANY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."El BARTANY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."El BARTANY1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."El BARTANY1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."El BARTANY1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."El BARTANY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."El BARTANY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."El BARTANY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."El BARTANY1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."El BARTANY1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."El BARTANY1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."El BARTANY1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."El BARTANY1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."El BARTANY1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━𝘽𝙆━━━━━━≫\n"
for k,v in pairs(list) do  
local El BARTANY_Msg = database:get(bot_id.."El BARTANY1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..El BARTANY_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevEl BARTANYW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevEl BARTANYW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'El_BARTANY')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevEl BARTANYW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevEl BARTANYW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..El BARTANY_Msg[math.random(#El BARTANY_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevEl BARTANYW(msg) then 
...
},function(ta,El BARTANY)
local t = "\nツ قائمة الاعضاء \n≪━━━━━━𝘽𝙆━━━━━━≫\n"
x = 0
local list = El BARTANY.members_
for k, v in pairs(list) do
x = x + 1
...
if text == ("مسح ردود المطور") and DevEl BARTANYW(msg) then 
...
if text == ("ردود المطور") and DevEl BARTANYW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❃∫ قائمة ردود المطور \n≪━━━━━━𝘽𝙆━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevEl BARTANYW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevEl BARTANYW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevEl BARTANYW(msg) then   
...
if text == 'تعطيل المغادره' and DevEl BARTANYW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'El BARTANY')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'El_BARTANY')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
El BARTANYdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevEl BARTANYW(msg) then
...
return false
  ...
  local Text =[[
    ...
    *❃م10 ◂ اوامر الاعضاء*
    ٴ≪━━━━━━𝘽𝙆━━━━━━≫ٴ
    彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/El_BARTANY)➢ 
  ]]
  keyboard = {} 
  ...
  {
  {text = 'ᵉˡ ᵇᵉʳᵗᵃᶰʸ «ᵇ» ᵗᵉᵃᵐ ‌♬⁩', url="t.me/El_BARTANY"},
  },
  }
...
zh = https.request('https://rudi-dev.tk/Amir1/El BARTANY.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━𝘽𝙆━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
gk = https.request('https://rudi-dev.tk/Amir2/El BARTANY.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/El BARTANY.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
El BARTANY = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(El BARTANY)
...
--------------------------------------------------------------------------------------------------------------
SourceEl BARTANY(data.message_,data)
...
------------------------------------------------------------------------
local El BARTANYAbot = database:get(bot_id.."El BARTANY1:Add:Filter:Rp2"..text..result.chat_id_)   
if El BARTANYAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..El BARTANYAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local El BARTANY1_Msg = database:get(bot_id.."El BARTANY1:Add:Filter:Rp2"..text..result.chat_id_)   
if El BARTANY1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..El BARTANY1_Msg)
